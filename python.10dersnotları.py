...
class  HTMY(MAKU):
    ...
    def bilgi(self):
           return f"bucak kykv yurdunu yakınlarındadır"
    def yerleske(self):
           return f"bucak yerkesinde bulunur"
       
htmy_1=HTMY(True,["bolum1","bolum2"],34)

print(htmy_1.yuksekokul)
print(htmy_1.bilgi())
print(htmy_1.yerleske())